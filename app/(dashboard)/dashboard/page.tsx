      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-end gap-4 mb-8">
        <div>
          ...
          <p className="text-slate-500 dark:text-slate-400 text-sm mt-1">
            ...
            ! You have{" "}
            <span className="text-[#00BCD4] font-bold">1 assignments</span>{" "}
            pending.
          </p>
        </div>
      </div>
        ...
        <div className="xl:col-span-8 flex flex-col gap-6">
          ...
          <div className="grid grid-cols-3 gap-2 md:gap-4">
            ...
            <div className="group bg-white dark:bg-slate-800 p-3 md:p-5 rounded-xl md:rounded-2xl border border-slate-200 dark:border-slate-700 hover:border-blue-300 dark:hover:border-blue-700 shadow-sm hover:shadow-md transition-all relative overflow-hidden">
              ...
              <div>
                <p className="text-[9px] md:text-xs text-slate-500 font-bold uppercase tracking-wider mb-0.5 truncate pr-4">
                  Study Time
                </p>
                <p className="text-base md:text-3xl font-extrabold text-slate-900 dark:text-white leading-none">
                  12.5
                  <span className="text-[10px] md:text-lg text-slate-400 font-medium ml-0.5">
                    h
                  </span>
                </p>
              </div>
            ...
            <div className="group bg-white dark:bg-slate-800 p-3 md:p-5 rounded-xl md:rounded-2xl border border-slate-200 dark:border-slate-700 hover:border-teal-300 dark:hover:border-teal-700 shadow-sm hover:shadow-md transition-all relative overflow-hidden">
              ...
              <div>
                <p className="text-[9px] md:text-xs text-slate-500 font-bold uppercase tracking-wider mb-0.5 truncate">
                  Courses
                </p>
                <p className="text-base md:text-3xl font-extrabold text-slate-900 dark:text-white leading-none">
                  3{" "}
          ...
          <div className="bg-white dark:bg-slate-800 rounded-2xl p-1 border border-slate-200 dark:border-slate-700 shadow-sm flex flex-col md:flex-row h-full overflow-hidden">
            ...
            <div className="p-6 md:p-8 flex flex-col justify-center flex-1">
              ...
              <h3 className="text-2xl md:text-3xl font-extrabold text-slate-900 dark:text-white mb-2 leading-tight">
                NgodingAI: GenAI Masterclass
              </h3>
              <p className="text-slate-500 text-sm mb-6 line-clamp-2 leading-relaxed">
                Module 3: Neural Networks & Deep Learning Architectures. You
                stopped at video{" "}
              ...
              <div className="mt-auto">
                ...
                <Link
                  href="/course/ngodingai"
                  className="flex items-center justify-center gap-2 w-full sm:w-auto bg-slate-900 dark:bg-white text-white dark:text-slate-900 px-6 py-3 rounded-xl font-bold text-sm hover:opacity-90 hover:shadow-lg hover:-translate-y-0.5 transition-all"
                >
            ...
            <div className="space-y-4">
              ...
              <div className="group flex gap-4 p-4 rounded-2xl bg-slate-50 dark:bg-slate-900/30 border border-slate-100 dark:border-slate-700 hover:bg-white hover:shadow-md hover:border-slate-200 transition-all cursor-pointer">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex justify-between items-start mb-1">
                    <h4 className="text-sm font-bold text-slate-900 dark:text-white group-hover:text-primary transition-colors truncate pr-2">
                      Error when installing LangChain on M1 Mac
                    </h4>
                    <span className="text-[10px] text-slate-400 whitespace-nowrap bg-white dark:bg-slate-800 px-2 py-0.5 rounded-full border border-slate-100 dark:border-slate-700">
                      2h ago
                    </span>
                  </div>
                  <p className="text-xs text-slate-500 line-clamp-1 mb-3">
                    I keep getting &apos;grpc&apos; build errors when running
                    pip install. Has anyone faced this issue before?
                  </p>
              ...
              <div className="group flex gap-4 p-4 rounded-2xl bg-slate-50 dark:bg-slate-900/30 border border-slate-100 dark:border-slate-700 hover:bg-white hover:shadow-md hover:border-slate-200 transition-all cursor-pointer">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex justify-between items-start mb-1">
                    <h4 className="text-sm font-bold text-slate-900 dark:text-white group-hover:text-primary transition-colors truncate pr-2">
                      Best wiring for Solenoid Lock 12V?
                    </h4>
                    <span className="text-[10px] text-slate-400 whitespace-nowrap bg-white dark:bg-slate-800 px-2 py-0.5 rounded-full border border-slate-100 dark:border-slate-700">
                      5h ago
                    </span>
                  ...
                  <p className="text-xs text-slate-500 line-clamp-1 mb-3">
                    Do I need a relay module or mosfet is enough for ESP32
                    project?
                  </p>
                  <div className="flex items-center gap-3">
                    <span className="text-[10px] font-bold text-slate-400 flex items-center gap-1 bg-white dark:bg-slate-800 px-2 py-1 rounded-md">
            ...
            <div className="space-y-4 flex-1">
              ...
              <div className="p-4 rounded-2xl border border-slate-100 dark:border-slate-700 hover:border-red-200 hover:bg-red-50/50 dark:hover:bg-red-900/10 transition-all bg-white dark:bg-slate-900/30 group">
                <div className="flex justify-between items-start mb-2">
                  <span className="text-[10px] font-bold bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-600 text-slate-600 dark:text-slate-300 px-2 py-0.5 rounded">
                    NgodingAI
                  </span>
                ...
                <h4 className="text-sm font-bold text-slate-900 dark:text-white mb-1 group-hover:text-red-600 transition-colors">
