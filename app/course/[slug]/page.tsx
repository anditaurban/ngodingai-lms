    ...
    <div className="flex flex-col min-h-full">
      ...
      <div className="bg-[#1b2636] text-white p-6 md:p-8 shrink-0">
        <div className="flex items-center gap-2 text-xs font-semibold text-slate-400 mb-4 uppercase tracking-wider">
          ...
          <span className="material-symbols-outlined text-[12px]">chevron_right</span>
          <span className="text-[#00BCD4] ml-2 text-xs bg-[#00BCD4]/10 px-2 py-0.5 rounded border border-[#00BCD4]/20">Active</span>
        </div>

        <div className="flex flex-col md:flex-row gap-6 items-start">
          <div className="w-full md:w-48 shrink-0 relative aspect-video rounded-lg overflow-hidden border border-white/10 shadow-lg group">
            <Image 
          ...
          <div className="flex-1">
            ...
            <div className="flex items-center gap-4 text-sm">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-[#00BCD4] font-bold">{foundCourse.progress}%</span>
              </div>
            </div>
          </div>
        </div>
          ...
          {['overview', 'preparation', 'classroom'].map((tab) => (
            <button
              ...
              className={`py-4 text-sm font-bold border-b-2 transition-all flex items-center gap-2 capitalize ${
                activeTab === tab 
                ? 'text-primary dark:text-[#00BCD4] border-primary dark:border-[#00BCD4]' 
          ...
          {activeTab === 'preparation' && (
            <div className="max-w-5xl mx-auto space-y-8 animate-fade-in">
              ...
              {foundCourse.tabs.preparation.slides_id && (
                ...
                >
                  <div className="size-16 rounded-lg bg-orange-50 dark:bg-orange-900/20 flex items-center justify-center text-orange-600 dark:text-orange-400 shrink-0 border border-orange-100 dark:border-orange-800/50 group-hover:scale-105 transition-transform">
                ...
                {!isEditing ? (
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-3 mt-4 justify-end">
                      ...
                      <button onClick={() => { setIsEditing(false); alert('Saved locally!'); }} className="px-6 py-2 bg-primary text-white font-bold rounded-lg shadow-lg">Save Changes</button>
                    </div>
                  </div>
                )}
              </div>
