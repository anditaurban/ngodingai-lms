...
// Kita tambahkan 'courseSlug' di sini agar TypeScript tidak marah
// seperti kejadian error 'PreparationTabProps' sebelumnya.
interface MaterialsTabProps {
  courseSlug?: string; 
  materials?: MaterialItem[] | any; 
}

export default function MaterialsTab({ courseSlug, materials = [] }: MaterialsTabProps) {
