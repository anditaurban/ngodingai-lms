...
export default function ArticleWorkspace({ title, setTitle, initialContent, onContentUpdate, onSave, onDelete }: ArticleWorkspaceProps) {
  ...
  return (
    <div className="animate-fade-in relative">
      ...
      <div className="max-w-4xl w-full mx-auto px-6 md:px-16 py-12 pb-40 flex flex-col gap-4">
        <div className="flex items-center justify-between mb-4 border-b border-slate-100 dark:border-slate-800/50 pb-4">
           <div className="flex items-center gap-2 text-[#00BCD4] font-bold text-sm tracking-wider uppercase">
           ...
           <div className="flex items-center gap-3">
              ...
              {/* ✨ MENGIRIM PAYLOAD KONTEN KE ONSAVE ✨ */}
