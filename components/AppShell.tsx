    ...
    <div className="px-4 lg:px-6 h-full flex items-center justify-between">
      ...
      <div className="flex items-center gap-4 md:gap-6">
        ...
        <div className="flex items-center gap-3 border-l border-slate-200 dark:border-slate-700 pl-4 h-8">
          <button className="text-slate-400 hover:text-[#00BCD4] transition-colors relative" title="Pusat Bantuan">
    ...
    <>
      ...
      `}>
        <div className="flex flex-col gap-2 p-4 pt-6 flex-1 overflow-y-auto custom-scrollbar">
          ...
          <p className="px-4 text-xs font-bold text-slate-500 uppercase tracking-wider mb-2 mt-6">Akademik</p>
          <a href="/reports" onClick={onClose} className="flex items-center gap-3 px-4 py-3 rounded-xl text-slate-400 hover:bg-white/5 hover:text-white group transition-all cursor-pointer">
            <span className="material-symbols-outlined group-hover:text-[#00BCD4]">bar_chart</span>
            <p className="text-sm font-medium">Laporan Progres</p>
          </a>
          
          <a href="/community" onClick={onClose} className="flex items-center gap-3 px-4 py-3 rounded-xl text-slate-400 hover:bg-white/5 hover:text-white group transition-all cursor-pointer">
            <span className="material-symbols-outlined group-hover:text-[#00BCD4]">group</span>
