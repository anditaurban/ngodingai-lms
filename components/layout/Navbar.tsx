      ...
      <div className="px-4 lg:px-6 h-full flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-3 cursor-pointer">
            {/* Teks Branding Responsif (Tumpuk di Mobile, Sejajar di Desktop) */}
            <div className="flex flex-col sm:flex-row sm:items-baseline sm:gap-1.5">
              <span className="text-[17px] sm:text-xl font-extrabold tracking-tight text-slate-900 dark:text-white leading-none sm:leading-normal">
                Inovasia
              </span>
              <span className="text-[11px] sm:text-xl font-bold sm:font-normal text-[#00BCD4] leading-none sm:leading-normal mt-0.5 sm:mt-0">
                Digital Academy
              </span>
            </div>
          </div>
